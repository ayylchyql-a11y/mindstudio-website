...
export const work: WorkEntry[] = [
  {
    ...
    tagline: {
        ...
        "zh-tw": "一家餐廳的整套點餐系統，從頭做到尾。",
        "ja": "レストランの注文システム一式を、端から端まで。",
        "ko": "한 식당의 주문 시스템 전체를, 처음부터 끝까지.",
        "fr": "Toute la chaîne de commande d'un restaurant, construite de bout en bout.",
        "de": "Der komplette Bestell-Stack eines Restaurants, end to end gebaut.",
        "es": "Todo el sistema de pedidos de un restaurante, construido de principio a fin.",
        "pt": "Todo o sistema de encomendas de um restaurante, construído de ponta a ponta.",
        "ru": "Вся система заказов ресторана, собранная от начала до конца.",
        "it": "L'intero stack di ordinazione di un ristorante, costruito end to end.",
        "ar": "منظومة الطلبات الكاملة لمطعم، مبنية من الألف إلى الياء.",
      },

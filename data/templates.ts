...
export const groups: TemplateGroup[] = [
  {
    ...
    intro: {
      en: "Ramen bar, all-you-can-eat, sushi takeaway, poke, gelato. Menu with category filters, a bowl builder, table and cake bookings, a cart that adds up an order.",
      zh: "拉面店、自助餐、寿司外卖、poke、冰淇淋。带分类筛选的菜单、配碗器、订座/订蛋糕弹窗、能加总的购物车。",
      "zh-tw": "拉麵店、吃到飽、壽司外帶、poke、冰淇淋。帶分類篩選的菜單、配碗器、訂位/訂蛋糕彈窗、能加總的購物車。",
      it: "Ramen bar, all you can eat, sushi da asporto, poke, gelato. Menù con filtri per categoria, bowl da comporre, prenotazione di tavoli e torte, carrello che somma l’ordine.",
    },
    accent: "#e05a3a",
  },
  {

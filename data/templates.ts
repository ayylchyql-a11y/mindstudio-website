...
export const groups: TemplateGroup[] = [
  {
    ...
    intro: {
      en: "Ramen bar, all-you-can-eat, sushi takeaway. Menu with category filters, table booking dialog, a cart that adds up an order.",
      zh: "拉面店、自助餐、寿司外卖。带分类筛选的菜单、订座弹窗、能加总的购物车。",
      "zh-tw": "拉麵店、吃到飽、壽司外帶。帶分類篩選的菜單、訂位彈窗、能加總的購物車。",
      it: "Ramen bar, all you can eat, sushi da asporto. Menù con filtri per categoria, prenotazione del tavolo, carrello che somma l’ordine.",
    },
    accent: "#e05a3a",
  },
  {
